...
The project is kept deliberately in step with upstream [`rfdetr`](https://github.com/roboflow/rf-detr) releases — currently **1.10.0**. Every upstream release triggers an alignment pass, recorded in [CHANGELOG.md](../CHANGELOG.md).
